...
const roomFeatures = [
  {
    name: 'Private High-Speed Internet',
  },
  {
    name: '60" TV Service',
  },
  ...
  {
    name: '2 Bathrooms with Shower (Master bathroom includes a dedicated tub)',
  },
  {
    ...
    <Box>
      <Box marginBottom={4}>
        ...
        <Typography variant="h6" align={'center'} color={'text.secondary'}>
          Here's a list of everything that comes with our Deluxe Family House.
        </Typography>
      </Box>
